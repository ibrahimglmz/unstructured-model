...
if TYPE_CHECKING:
    from unstructured.inference.elements import TextRegion
    from unstructured.inference.layout import DocumentLayout, PageLayout
    from unstructured.inference.layoutelement import LayoutElement
    from unstructured.models.tables import UnstructuredTableTransformerModel
...
def process_file_with_ocr(
    ...
    from unstructured.inference.layout import DocumentLayout
...
def supplement_page_layout_with_ocr(
    ...
    if infer_table_structure:
        from unstructured.models import tables
